...
def build_response_plan_messages(
    *,
    ...
    system = (
        ...
        "external exfil/C2 destinations and malicious domains. Exception: for "
        "event_type lateral_movement, also block internal pivot destination IPs "
        "(dst_ip) — those are the lateral path, not VPN egress.\n"
